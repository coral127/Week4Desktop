...
public class TalkManager : MonoBehaviour
{
    ...
    void Awake()
    {
        talkData = new Dictionary <int, string[]>(); //Dictionary에 대화 데이터 저장
    ...
    void GenerateData()
    {
        ...
        talkData.Add(2000, new string[] { "여어:1", "이 호수는 참 아름답지?:0","사실 이 호수에는 어떤 비밀이 숨겨져있다고 해.:1" });
        ...
        talkData.Add(11 + 2000, new string[]{"어여.:1",
                                            "이 호수의 전설을 들으러 온거야?:0",
        ...
        talkData.Add(21 + 2000, new string[] { "엇, 찾아줘서 고마워.:0", });

        //Portrait Data
        //0: smile, 1: Talk, 2:Angey, 3:Normal
